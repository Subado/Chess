...
void MenuState::updateOptionText()
{
	...
	{
		text.setOutlineColor(sf::Color(0xECEFF4));
		text.setFillColor(sf::Color(0xECEFF4));
	}

	m_options[m_optionIndex].setOutlineColor(sf::Color(0xA3BE8C));
	m_options[m_optionIndex].setFillColor(sf::Color(0xA3BE8C));
}
